...
# =========================================================
# NOTE: this file only talks to Groq. The Google API key is only needed by
# tools.py's token-chunking helper, so we no longer hard-crash the whole app
# at import time if it's missing — tools.py already has its own graceful
